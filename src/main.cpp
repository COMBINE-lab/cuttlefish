...
void build(int argc, char** argv)
{
    ...
    options.add_options()
        ...
        ("k,kmer_len", "k-mer length", cxxopts::value<uint16_t>()->default_value("25"))
        ...
        ("f,format", "output format (0: txt, 1: GFA 1.0, 2: GFA 2.0)", cxxopts::value<uint16_t>()->default_value("0"))
